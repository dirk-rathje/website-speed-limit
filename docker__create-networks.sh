...
docker network create --driver bridge --subnet=192.168.37.0/24 --gateway=192.168.37.10 --opt "com.docker.network.bridge.name"="docker5" dsl20
tc qdisc add dev docker2 root handle 1: htb default 12
tc class add dev docker2 parent 1:1 classid 1:12 htb rate 20mbit ceil 20mbit
tc qdisc add dev docker2 parent 1:12 netem delay 28ms
